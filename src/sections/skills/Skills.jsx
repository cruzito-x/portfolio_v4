    ...
    <div className="container p-5 h-100" id="skills">
      ...
      <div className="row mt-5">
        <div className="col-md-2 col-sm-3 text-center">
          <>
            <img src="src/assets/icons/skills/html.svg" alt="" /> <br />
            <label className="html-text fw-semibold fs-6 mt-3">HTML</label>
          </>
        </div>
        <div className="col-md-2 col-sm-3 text-center">
          <>
            <img src="src/assets/icons/skills/css.svg" alt="" /> <br />
            <label className="css-text fw-semibold fs-6 mt-3">CSS</label>
          </>
        </div>
        <div className="col-md-2 col-sm-3 text-center">
          <>
            <img src="src/assets/icons/skills/javascript.svg" alt="" /> <br />
        ...
        <div className="col-md-2 col-sm-3 text-center">
          <>
            <img src="src/assets/icons/skills/bootstrap.svg" alt="" /> <br />
        ...
        <div className="col-md-2 col-sm-3 text-center">
          <>
            <img src="src/assets/icons/skills/react.svg" alt="" /> <br />
            <label className="react-text fw-semibold fs-6 mt-3">React.js</label>
          </>
        </div>
        <div className="col-md-2 col-sm-3 text-center">
          <>
            <img src="src/assets/icons/skills/angular.svg" alt="Angular logo" />{" "}
            <br />
      ...
      <div className="row mt-5">
        <div className="col-md-2 col-sm-3 text-center">
          <>
            <img src="src/assets/icons/skills/node.svg" alt="" /> <br />
        ...
        <div className="col-md-2 col-sm-3 text-center">
          <>
            <img src="src/assets/icons/skills/laravel.svg" alt="" /> <br />
        ...
        <div className="col-md-2 col-sm-3 text-center">
          <>
            <img src="src/assets/icons/skills/mysql.svg" alt="" /> <br />
        ...
        <div className="col-md-2 col-sm-3 text-center">
          <>
            <img
              src="src/assets/icons/skills/git.svg"
              className="rounded"
              alt="Git logo"
            />{" "}
            <br />
        ...
        <div className="col-md-2 col-sm-3 text-center">
          <>
            <img src="src/assets/icons/skills/figma.svg" alt="Figma logo" />{" "}
            <br />
        ...
        <div className="col-md-2 col-sm-3 text-center">
          <>
            <img src="src/assets/icons/skills/swagger.svg" alt="Swagger logo" />{" "}
            <br />
